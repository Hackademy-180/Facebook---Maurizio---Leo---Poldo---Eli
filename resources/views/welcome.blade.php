<x-layout>
    <main class="container d-flex justify-content-center my-3 ">
        <section class="row flex-column">
            ...
            <div class="card shadow-sm mb-3 card-custom" data-aos="fade-right" style="border-radius: 10px;">
                <div class="card-body ">
                    ...
                    <a class="btn btn-custom" href="{{route("show_post",compact("post"))}}">Leggi commenti</a>
                    @if(Auth::user() && Auth::user()->id == $post->user_id)
                    <a class="btn btn-custom" href="{{route("create_comment",compact("post"))}}">Commenta</a>
                    <a class="btn btn-custom Btn" href="{{route("edit_post",compact("post"))}}">Modifica post <svg class="svg" viewBox="0 0 512 512">
        ...
        <div class="mt-4 ">
            ...
            @auth
            <div class="mb-3 mx-5 position-fixed bottom-0 end-0 m-3">
